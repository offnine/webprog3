...
<html>
    ...
    <body>
        ...
        <table class="table-cars">
            <tr><th class="head-title"colspan="2">Admin page (törlés az adatbázisból)</th></tr>
            ...
            <tr>
                ...
                <?php foreach ($items as $item): ?>
                    ...
                    <br><br><b><?=lang('desc')?> </b><?=$item['text']?>
                        ...
                        <br><br><a button onclick="clickDelete()"><a style="color: black" href="<?=site_url('cars/delete/'.$item['slug'])?>"><?=lang('delete')?></a></button> 
                        <br><br>
                    </td>
